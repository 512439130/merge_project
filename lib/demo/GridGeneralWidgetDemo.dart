...
import 'package:merge_project/demo/bean/HeaderBean.dart';
import 'package:merge_project/demo/bean/ImageBean.dart';
import 'package:merge_project/demo/bean/LocalImageBean.dart';
import 'package:merge_project/demo/const/Constant.dart';
import 'package:merge_project/demo/util/ListUtil.dart';
import 'package:merge_project/demo/util/PermissionUtil.dart';
import 'package:merge_project/demo/util/PictureUtil.dart';
import 'package:merge_project/demo/util/ToastUtil.dart';
import 'package:merge_project/demo/dialog/BottomPickerHandler.dart';
import 'package:merge_project/demo/dialog/ProgressDialog.dart';
import 'package:merge_project/demo/widget/GridGeneralWidget.dart';
...
class GridGeneralWidgetDemoState extends State<GridGeneralWidgetDemo> with TickerProviderStateMixin implements BottomPickerListener {
  ...
  Widget build(BuildContext context) {
    ...
    double parentWidth = ScreenUtil.getInstance().setWidth(Constant.screen_width);
