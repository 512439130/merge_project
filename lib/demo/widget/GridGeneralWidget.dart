          ...
          new Container(
            ...
            child: new Center(
                child: new GridView.count(
                  ...
                  mainAxisSpacing: widget.type == Constant.grid_general_header? ScreenUtil.getInstance().setHeight(20):widget.itemVerticalSpacing, //上下间距
                  crossAxisSpacing: widget.itemHorizontalSpacing, //左右间距
                  padding: const EdgeInsets.fromLTRB(0, 0, 0, 0),
                  primary: false,
                  shrinkWrap: true,
                  childAspectRatio: widget.type == Constant.grid_general_header? 3 / 5:1,
                  children: listWidget,
                )),
          ),
        ]);
